...
class BackpackTest < MiniTest::Test
  ...
  def test_that_backpack_contains_gym_shoes_on_mondays_and_thursdays
  ...
  def test_that_backpack_does_not_contain_gym_shoes_not_on_mondays_and_thursdays
...
- gym shoes
- packed lunch"
    assert_equal(expected, backpack.packing_list)
  end
